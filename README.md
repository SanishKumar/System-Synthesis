...
Current automated count: 40 architecture-core tests, 7 CLI tests, 17 Action tests, and 95 backend tests (159 total). The Next.js production build type-checks and prerenders the review list, review detail, and repository-connections routes.
