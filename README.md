...
Current automated count: 92 architecture-core tests, 7 CLI tests, 24 Action tests, and 121 backend tests (244 total). The Next.js production build type-checks and prerenders the review list, review detail, and repository-connections routes.
